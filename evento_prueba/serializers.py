...
class EventoSerializers( serializers.ModelSerializer ):
    ...
    class Meta:
        model = Evento
        fields  = ['codigo','titulo','descripcion','direccion','fecha','disponible','rutaLugar','calificacionP','idDepartamento','imagenes']
...
class EventoSerializerModificacion( serializers.ModelSerializer):
    ...
    class Meta:
        model = Evento
        fields = ['titulo','descripcion','direccion','fecha','disponible','rutaLugar','idDepartamento','imagenes']
